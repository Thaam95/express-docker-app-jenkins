pipeline {
    ...
    options { 
        // ถ้า job เป็นแบบ Pipeline from SCM / Multibranch แนะนำให้เปิดตัวนี้
    ...
    environment {
        ...
        DOCKER_REPO               = "thaamamg/express-docker-app-jenkins"
    ...
    stages {
        ...
        stage('Deploy Local') {
            ...
            // post ของ stage นี้จะทำงานเมื่อ stage Deploy Local success เท่านั้น
            post {
                success {
                    script {
